...
// ------------------------------------------------------------------------------------------
/**
 * @apiDefine CreateUserErrorTEST
 * @apiVersion 0.2.0
 *
 * @apiError NoAccessRight Only authenticated Admins can access the data TEST.
 * @apiError UserNameTooShort Minimum of 5 characters required TEST.
 *
 * @apiErrorExample  Response (example):
 *     HTTP/1.1 400 Bad Request
 *     {
 *       "error": "UserNameTooShort TEST"
 *     }
 */
